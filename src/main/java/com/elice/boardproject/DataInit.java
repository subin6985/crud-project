...
public class DataInit {
    ...
    public void init() {
        ...
        User user1 = new User("elice", "1234", "엘리스", "email1@elice.com", "src/main/resources/static/hellobit.png");
        ...
        this.commentRepository.save(new Comment(post, user2, "우와 재밌었겠어요~"));
    }
}
